_base_ = ["../../_base_/default_runtime.py", "../../_base_/datasets/vegann_640x640.py"]
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        img_suffix="-TVT-split4.png",
        seg_map_suffix="-TVT-split4.png",
    ),
)
val_dataloader = dict(
    dataset=dict(
...
# learning policy
param_scheduler = [
    dict(type="PolyLR", eta_min=0, power=0.9, begin=0, end=30000, by_epoch=False)
]
